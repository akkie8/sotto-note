      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-lg bg-white p-4 shadow">
            ...
            <p
              className={`text-lg font-semibold ${user ? "text-green-600" : "text-red-600"}`}
            >
              {user ? "✅ 認証済み" : "❌ 未認証"}
            </p>
          ...
          <div className="rounded-lg bg-white p-4 shadow">
            ...
            <p
              className={`text-lg font-semibold ${isRefreshing ? "text-blue-600" : "text-gray-600"}`}
            >
          ...
          <div className="rounded-lg bg-white p-4 shadow">
            ...
            <p
              className={`text-lg font-semibold ${lastError ? "text-red-600" : "text-green-600"}`}
            >
              {lastError || "✅ エラーなし"}
            </p>
          </div>
