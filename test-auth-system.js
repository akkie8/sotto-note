...
async function testJWTExpiration() {
  ...
  // JWTデコード機能をテスト
  const testToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVheW1za3BybnVyYmh2dHRjeWtlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg1MjA0NDAsImV4cCI6MjA2NDA5NjQ0MH0.WpTQlV31j-Y3NlkjoZaoy5YZQ-g4qrZ9-laTh4s6r10';
  ...
  try {
    ...
    console.log(`   📅 テストトークン有効期限: ${new Date(expirationTime * 1000).toLocaleString()}`);
